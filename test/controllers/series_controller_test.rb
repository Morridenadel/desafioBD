...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference("Serie.count") do
      post series_url, params: { series: { diector: @series.diector, name: @series.name, synopsis: @series.synopsis } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { diector: @series.diector, name: @series.name, synopsis: @series.synopsis } }
